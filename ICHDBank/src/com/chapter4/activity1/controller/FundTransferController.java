...
import com.chapter4.activity1.model.FundTransfer;
import com.chapter4.activity1.transferfund.FundTransferApp;
import com.chapter4.activity1.transferfund.ValidatingFundTransfer;
...
public class FundTransferController {
	...
	public String processForm(@ModelAttribute(value = "transferaccount") FundTransfer act, ModelMap model) {
		String message = "";
		ApplicationContext ctx = new ClassPathXmlApplicationContext("com/chapter4/activity1/config/Spring-Config.xml");
